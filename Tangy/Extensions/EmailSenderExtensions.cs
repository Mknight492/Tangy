...
namespace Tangy.Services
{
    public static class EmailSenderExtensions
    {
        ...
        public static Task SendOrderStatusAsync(this IEmailSender emailSender, string email, string orderNumber,
            string status)
        {
            string subject = "";
            string message = "";
            ...
            if (status == SD.StatusReady)
            {
                ...
                message = "Order Number: " + orderNumber +
                          " is ready for Pickup! Please contact us if you have any questions.";
            }
